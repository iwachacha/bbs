...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'year' => '年',
        'univ_email' => 'メールアドレス',
        'lecture.lecture_name' => '講義名',
        'lecture.professor_name' => '担当教員名',
        'lecture.lecture_category_id' => '講義カテゴリー',
        'lecture.faculty_id' => '開講学部',
        'lecture.department_id' => '開講学科・課程',
        'lecture.course_id' => '開講コース・専修',
        'lecture.season' => '開講時期',
        'lecture.grade' => '開講学年',
        'review.title' => 'タイトル',
        'review.rate_credit' => '楽単度',
        'review.rate_adequacy' => '充実度',
        'review.rate_fun' => '面白さ',
        'review.year' => '受講年度',
        'review.class_method' => '授業方式',
        'review.attedance' => '出席確認',
        'review.evaluation_method' => '評価方法',
        'review.evaluation_level' => '評価レベル',
        'review.lecture_level' => '講義レベル',
        'review.comp_syllabus' => 'シラバスと講義の比較',
        'review.lecture_content' => '講義内容',
        'review.dtail' => '詳細',
    ],
